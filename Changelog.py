...
1.4.3 - March 25, 2017
    ...
    - Main menu is now its own class MainMenu
        menu() and repeat() removed from Main
    - Driver and changelog are their own files
        - Driver calls MainMenu.printSplashArt()
    - Moved object instantiation to respective class files
1.4.2 - Feb. 18, 2017
    Spaghetti code update
    - Demon words now composed of classes instead of functions and global variables
