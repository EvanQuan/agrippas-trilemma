...
public class Word {
    ...
    /**
     * While the {@link game.system.input.PlayerInputParser} will treat any word
     * that ends with "ly" as an adverb for parsing strings into {@link
     * PlayerCommand}s, the game will reject all adverbs it doesn't recognize.
     */
     ...
     * from a {@link PlayerCommand} into multiple {@link
     * game.system.input.PlayerAction}s.
     *
     * @param word to check
