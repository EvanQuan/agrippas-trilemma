...
/**
 * The main window of the game. Contains all GUI components. This window and its
 * constituent parts store and communicate all parts of the game logic.
 *
 * @author Evan Quan
 */
public class MainFrame extends JFrame {
    ...
    /**
     * Sets the application icon from the default Java logo to the custom game
     * icon.
     */
