...
/**
 * Prints text to {@link OutputPanel} GUI. Does not wrap text as wrapping is
 * done automatically (and dynamically as window size changes.
 *
 * @author Evan Quan
 * @deprecated {@link OutputPanel} now directly implements {@link IPrintBuffer}
 * and no longer needs this intermediate class. No longer implements
 * IPrintBuffer so that it no longer needs to update as IPrintBuffer updates.
 */
@Deprecated
