...
public class Exit implements Serializable {
     ...
     *
     * @param direction         the exit is leading to
     * @param leadsTo           the location the exit refers to
     * @param openable          if the exit is openable from the current room
     * @param open              if the exit can be traveled to
     * @param openedDescription the description of the open exit
     * @param closedDescription the description of the closed exit
     */
     ...
     * @return exit created
     * @throws IllegalArgumentException if invalid type, kind, direction, or
     *                                  leadsTo
     */
    ...
    /**
     * @param leadsTo Location of this exit
     */
     ...
     *
     * @param shortDirectionName of exit
     */
    ...
    /**
     * Set if the exit if open or not. If open the exit can travel through, else
     * the it cannot.
     *
     * @param open status of exit
     */
