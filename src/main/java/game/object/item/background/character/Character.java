...
/**
 * Can be contained in rooms May have inventories Is either alive or dead
 */
public abstract class Character extends BackgroundItem {
     ...
     *
     * @param collectible to put inside inventory
     */
    public void take(Collectible collectible) {
        inv.add(collectible);
    }
     ...
     *
     * @param count       of collectible
     * @param collectible to put inside inventory
     */
    public void take(int count, Collectible collectible) {
        inv.add(count, collectible);
    }
