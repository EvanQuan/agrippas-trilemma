...
public class Multiset<E> implements Iterable<E> {
    ...
    /**
     * All elements are contained in HashMap where E tracks the element, and Integer
     * tracks the count of the element
     */
     ...
     * operation). Returns true if this multiset changed as a result of the call.
     * (Returns false if this multiset does not permit duplicates and already
     * contains the specified element.)
     * <p>
     * Collections that support this operation may place limitations on what
     * elements may be added to this multiset. In particular, some multiset will
     * refuse to add null elements, and others will impose restrictions on the type
     * of elements that may be added. Collection classes should clearly specify in
     * their documentation any restrictions on what elements may be added.
     * <p>
     * If a multiset refuses to add a particular element for any reason other than
     * that it already contains the element, it must throw an exception (rather than
     * returning false). This preserves the invariant that a multiset always
     * contains the specified element after this call returns.
     *
     * @param element
     *            - element whose presence in this multiset is to b ensured
    ...
    /**
     * Adds all of the elements in the specified multiset to this multiset (optional
     * operation). The behavior of this operation is undefined if the specified
     * multiset is modified while the operation is in progress. (This implies that
     * the behavior of this call is undefined if the specified multiset is this
     * multiset, and this multiset is nonempty.) This implementation iterates over
     * the specified multiset, and adds each object returned by the iterator to this
     * multiset, in turn.
     *
     * @param other
     *            - multiset containing elements to be added to this multiset
     * @return true if this multiset changed as a result of the call
     */
     ...
     *
     * @param other
     *            - multiset to compare if this multiset contains it
    ...
    /**
     * Returns the number of occurrences of an element in this multiset (the count
     * of the element).
     *
     * @param element
    ...
    /**
     * Comparing with some other non-multiset object automatically does not equal
     * this multiset
     *
     * @param other
     *            - object
    ...
    /**
     * Removes a single instance of the specified element from this multiset, if it
     ...
     * @param occurrences
     *            - the number of occurrences of the element to remove. May be zero,
     *            in which no change will be made
    ...
    /**
     * Remove all occurrences of all elements of other multiset from this multiset
     *
     * @param other
     *            - multiset
     ...
     *
     * @param element
     *            - the element to conditionally remove all occurrences of
     ...
     * multiset. In other words, remove from this multiset all of its occurrences
     * that are not the specified element.
     *
     * @param element
     *            - the element to conditionally retain all occurrences of
