...
public class ConsolePrinter implements IPrinter {
    ...
    public ConsolePrinter() {
        ...
        characterColor = ConsoleColors.YELLOW_BOLD;
        locationColor = ConsoleColors.GREEN_BOLD;
        itemColor = ConsoleColors.RED_BOLD;
        speechColor = ConsoleColors.GREEN_BOLD_BRIGHT;
        titleColor = ConsoleColors.PURPLE_BOLD_BRIGHT;
    }
