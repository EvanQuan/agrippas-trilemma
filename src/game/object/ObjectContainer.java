...
public class ObjectContainer<T extends GameObject> implements Serializable {
    ...
    /**
     * Add count of item inside inventory If count results in negative item count,
