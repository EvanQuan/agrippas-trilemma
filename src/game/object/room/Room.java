...
public abstract class Room extends GameObject {
    ...
    private ObjectContainer<Person> people;
    ...
    public Room() {
        ...
        people = new ObjectContainer<Person>();
    ...
    public void outputItems() {
        ...
        if (!inv.isEmpty()) {
            ...
            int count;
            for (Collectible item : inv.getObjectSet()) {
                ...
                if ((i == inv.getObjectCount() - 2) && (inv.getObjectCount() > 1)) { // second last
                    output(" and ");
                } else if (i == inv.getObjectCount() - 1) { // last
                    outputln(" here.");
                } else {
                    output(", ");
                }
    ...
    public void setInventory(ObjectContainer<Collectible> inv) {
        this.inv = inv;
    }
    ...
    public ObjectContainer<Person> getPeople() {
        return people;
    }
    public void setPeople(ObjectContainer<Person> people) {
        this.people = people;
    }
