...
public abstract class Menu {
    ...
    /**
     * Get input from user and stores the line in inputLine and individual words in
     * inputWords
     */
    ...
    private boolean inputStartsWithChoice(ArrayList arrayList, boolean strip, boolean setVerb) {
        ...
        if (testElement instanceof String) {
            ...
            for (int i = 0; i < arrayList.size(); i++) { // search for entry with most words
                ...
                word = String.join(" ", Arrays.copyOfRange(inputWords, 0, words.length)); // make start comparison
