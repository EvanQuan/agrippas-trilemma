...
class Item(object):
    def __init__(self, name = False, names = False, description = False):
        self.name = name
        self.names = names
...
class Gold(Item):
    def __init__(self):
        Item.object.__init__(self)
        self.name = "gold"
        self.names = "gold"
        self.description = "The edges are worn down from handling."
gold = Item(name = "gold", description = "The edges are worn down from handling.")
