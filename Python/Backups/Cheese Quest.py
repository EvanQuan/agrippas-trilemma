...
# All the background file stuff not directly accessable in game
# class Program(object):L
# def __init__(self, )
#
...
class Stat(object):
    ...
    def lowerHunger(self):
        if not (roomID.startswith("roomDarkness") or roomID.startswith("roomBook")):
            self.hunger -= 1
...
def menu():
    ...
    while not choice_made:
        ...
        if option in ("1","1.","start","start game","1. start game"):
            ...
            print("Cheese Quest: The Plight of Kashkaval was developed by Evan Quan from on Oct. 17, 2016 to " + DATE + " because he was bored and had a lot of free time.")
